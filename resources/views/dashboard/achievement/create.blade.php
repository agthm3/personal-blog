        ...
        <div class="row g-4">
            <div class="col-sm-12 col-xl-12">
                ...
                <div class="bg-light rounded h-100 p-4">
                    <form action="{{ route('store_achievement') }}" method="post">
                        @csrf
                        ...
                        <div class="form-floating">
                            ...
                            <h6 class="mb-2 mt-2">Pencapaian</h6>
                            <input type="text" class="form-control mt-2" id="input-github" name="achievement" />
